...
public class Student_Register_Activity extends AppCompatActivity {
    ...
    Button sButton;
    TextView link;
    String url = "http://cmpbijnor.navigem.net/SIS_API/user_registration.php";
                    ...
                    if (!email.contains("@")) {
                        ...
                        if (password.length() < 6) {
                            ...
                            if (!password.equals(confirmpass)) {
                                ...
                                insertData(username,usnno,dob,phoneno,email,gender,password,confirmpass);

                                Intent intent1 = new Intent(Student_Register_Activity.this, Student_Login_Activity.class);
    ...
    private void insertData(final String username, final String usnno, final String dob,final String phoneno,final String email,
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    try {
                        ...
                        Toast.makeText(Student_Register_Activity.this, result, Toast.LENGTH_SHORT).show();
                    }
