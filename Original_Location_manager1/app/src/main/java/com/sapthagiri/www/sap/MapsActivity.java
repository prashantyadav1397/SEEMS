...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng dangerous_area = new LatLng(12.960016, 77.647004);
        ...
        geoService.startService(dangerous_area,75);
    }
    ...
    public static class GeoService extends Service implements GoogleApiClient.ConnectionCallbacks,
        ...
        private void displayLocation() {
            ...
            if (mLastLocation != null) {
                ...
                Log.d("LOC", String.format("Your last location was chaged: %f / %f", latitude, longitude));
            } else {
                Log.d("LOC", "Can not get your location.");
            }
        }
